...
mkdir build-qtbase
cd build-qtbase
call %SRC_qtbase%\configure.bat -shared -release -nomake examples -prefix %INSTALL_DIR% -opensource -confirm-license -qt-libpng -qt-libjpeg -qt-zlib -qt-pcre -qt-freetype -schannel -opengl desktop -platform win32-g++ -no-sql-psql -openssl-linked -DOPENSSL_ROOT_DIR="D:\a\buildQt\openssl"
