...
:: 设置MinGW版本代号
SET MinGW_VERSION=mingw1420_32_RP
...
mkdir build-qtbase
cd build-qtbase
call %SRC_qtbase%\configure.bat -shared -release -nomake examples -nomake tools -prefix %INSTALL_DIR% -opensource -confirm-license -qt-libpng -qt-libjpeg -qt-zlib -qt-pcre -qt-freetype -no-sql-psql -schannel -opengl desktop -platform win32-g++
